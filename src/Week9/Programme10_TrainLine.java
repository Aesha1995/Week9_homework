...
public class Programme10_TrainLine {
    ...
    {
        char result; //store the result value
        //list of all zone 1 station
        ...
        HashMap<String, String> zone = new HashMap<String, String>(); //hashmap obj created
        //obj elements
        ...
        do
        {
            ...
            name1 = name1.toUpperCase(); //convert string to uppercase

            for (String i : zone.keySet()) //logic to check for condition
            {
                if (name1.equals(i))
                {
            ...
            scan.close();
        } while (result == 'Y' || result == 'y'); //if user enter Y or y loop execute again till user press N
